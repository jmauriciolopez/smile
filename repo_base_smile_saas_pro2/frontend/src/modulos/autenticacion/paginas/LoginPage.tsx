    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
      <div className="w-full max-w-sm rounded-3xl bg-white p-10 shadow-xl shadow-slate-200/50 animate-in fade-in zoom-in-95 duration-500">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Bienvenido a Smile</h1>
          <p className="mt-2 text-sm text-textoSecundario">Ingresá a tu panel clínico</p>
        </div>
